...
export default function DiagnosticPage() {
  return (
    <main className="min-h-screen bg-background py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 -z-10 w-1/3 h-1/3 bg-primary/5 rounded-lg blur-[100px]" />
      <div className="absolute bottom-0 left-0 -z-10 w-1/3 h-1/3 bg-accent/5 rounded-lg blur-[100px]" />

      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12 space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-lg bg-primary/10 text-primary text-sm font-bold tracking-wide">
