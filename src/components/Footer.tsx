...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="relative border-t-2 border-foreground/80">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            {/* Brand */}
            <div className="md:col-span-2 space-y-4">
              <Link href="/" className="flex items-center gap-2 group">
                <div className="w-8 h-8 rounded-xl gradient-bg flex items-center justify-center shadow-md border-2 border-foreground/80">
          ...
          {/* Bottom Bar */}
          <div className="mt-12 pt-6 border-t-2 border-foreground/30 flex flex-col items-center gap-4">
            <p className="text-xs text-muted-foreground text-center">
              &copy; {new Date().getFullYear()} Muakeup. {t.footer.allRightsReserved}
            </p>
            <div className="flex items-center gap-4">
              <span className="text-xs text-muted-foreground px-3 py-1 rounded-full bg-white/50 border-2 border-foreground/60 shadow-[2px_2px_0px_0px_rgba(132,148,255,0.3)]">
                v1.0
              </span>
            </div>
          </div>
